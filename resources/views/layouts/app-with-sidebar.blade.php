...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @if(request()->is('/') || request()->is('dashboard') || request()->is('home') || request()->is('matches') || request()->is('matches/*') || request()->is('roommates') || request()->is('roommates/*') || request()->is('activity') || request()->is('messages') || request()->is('messages/*'))
        <link href="{{ asset('css/global-theme.css') }}?v=5" rel="stylesheet">
        @endif
